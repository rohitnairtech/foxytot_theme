			...
			<div class="error-404 not-found">
				...
				<div class="page-content">
					...
					<header class="page-header">
						<h1 class="page-title"><?php esc_html_e( 'Oops! Product couldn&rsquo;t be found.', 'storefront' ); ?></h1>
					</header><!-- .page-header -->
					...
					if ( storefront_is_woocommerce_activated() ) {
						...
						echo '<div class="fourohfour-columns-2">';
							...
							echo '<section class="col-12" aria-label="' . esc_html__( 'Promoted Products', 'storefront' ) . '">';
